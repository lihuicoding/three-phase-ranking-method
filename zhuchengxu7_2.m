...
close all
clear all
X=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\无监督排序用\2CSM2014数据集合2015数据集\2014-and-2015-CSM-dataset','D2:K188'); 
J = [1 1 2 1 1 1 2 1];
[m,n] = size(X);
A=zeros(m,n);
for j = 1:n
...
s=xlswrite('paixu_7_2.xls', result);    % 将result写入到paixu.xls文件中
