function [PX5_xiang,f_DOM1_xiang,f_DOM2_xiang,f_DOM3_xiang,xiangdui_POS,xiangdui_NEG]=Zhang202138413856_xiang(TA,W,H,Q)
...
DOM1;  %正域
f_DOM1_xiang=find(DOM1==1);    %%%%%%%%%%%%%%%%%%%%%%%%%%分类到z域中的对象的位置
DOM2;   %边界域
f_DOM2_xiang=find(DOM2==1);    %%%%%%%%%%%%%%%%%%%%%%%%%%分类到b域中的对象的位置
DOM3;   %负域
f_DOM3_xiang=find(DOM3==1);    %%%%%%%%%%%%%%%%%%%%%%%%%%分类到负域中的对象的位置
PX5_xiang=PX;
end
