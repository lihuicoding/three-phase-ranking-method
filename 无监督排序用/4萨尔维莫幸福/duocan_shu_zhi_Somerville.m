...
ranking=data';
class=xlsread('C:\Users\Administrator\Desktop\工作 安大写文章\工作第2篇- 准则偏好下的三支多准则决策方法\程序\本身\实验分析\实验—有序分类—萨尔维莫幸福\Somerville','A2:A144');
...
s3=xlswrite('youxu_fenlei_Somerville.xls', result3);    % 将result写入到文件中
