...
close all
clear all
%X=xlsread('C:\Users\Administrator\Desktop\第7篇\程序\无监督排序用\3葡萄酒\winequality-red','F18:K21');
X1=xlsread('C:\Users\Administrator\Desktop\第7篇\程序\无监督排序用\3葡萄酒\winequality-white','H2:K4899');
X=X1([15 16 17 18 47],:);
J = [2 1 2 1];
[m,n] = size(X);
A=zeros(m,n);
...
s=xlswrite('paixu_7_5.xls', result);    % 将result写入到paixu.xls文件中
