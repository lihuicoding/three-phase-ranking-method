...
close all
clear all
X=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\有监督排序用\7abalone\abalone','A14:H4190');
J = [2 1 1 1 1 1 1 1];
[m,n] = size(X);
A=zeros(m,n);
for j = 1:n
...
X1=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\有监督排序用\7abalone\abalone','I14:I4190');
...
s=xlswrite('paixu_abalone.xls', result);    % 将result写入到paixu.xls文件中
...
s3=xlswrite('LRI_abalone.xls', result3);    % 将result写入到文件中
...
s1=xlswrite('weizhi_abalone.xls', result1);    % 将result写入到paixu.xls文件中
...
s2=xlswrite('GRI_abalone.xls', result2);    % 将result写入到paixu.xls文件中
