...
close all
clear all
X=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\有监督排序用\8compactiv\compactiv','A1:U8192');
...
X1=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\有监督排序用\8compactiv\compactiv','V1:V8192');
...
s3=xlswrite('LRI_compactiv.xls', result3);    % 将result写入到文件中
...
s2=xlswrite('GRI_compactiv.xls', result2);    % 将result写入到paixu.xls文件中
