...
close all
clear all
X=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\有监督排序用\9friedman\friedman','A11:E1210');
J = [1 1 1 1 1];
[m,n] = size(X);
A=zeros(m,n);
for j = 1:n
...
X1=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\有监督排序用\9friedman\friedman','F11:F1210');
...
s3=xlswrite('LRI_friedman.xls', result3);    % 将result写入到文件中
...
s2=xlswrite('GRI_friedman.xls', result2);    % 将result写入到paixu.xls文件中
