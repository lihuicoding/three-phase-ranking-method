...
close all
clear all
X=xlsread('C:\Users\张凯凯\Desktop\张bo7程序\无监督排序用\3葡萄酒\winequality-red','A2:K1600'); 
J = [1 1 2 2 2 2 1 2 2 1 1];
[m,n] = size(X);
A=zeros(m,n);
for j = 1:n
	if J(j) == 1
...
s=xlswrite('paixu_7_3.xls', result);    % 将result写入到paixu.xls文件中
