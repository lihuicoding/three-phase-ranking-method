...
close all
clear all
X=xlsread('C:\Users\Administrator\Desktop\第7篇\程序\计算机硬件\machine','C3:H211'); 
J = [2 1 1 1 1 1];
[m,n] = size(X);
% 1.Normalization
A = zeros(m,n);
...
%H=[ 0.33    0.67    0.55     0.83    0.41     0.35];%面向准则的模糊概念H，h_j
...
f_BND=find(BND==1);   %%%%%%%%%%%%%%%%%%%%%%%%%%分类到边界域中的对象的位置
